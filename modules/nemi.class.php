...
/**
 * Class for downloading Nemi comics
...
class nemi {
	...
	public function generate($dir) {
		...
		/** Grap today comics image */
		
		
		$c = curl_init();
		curl_setopt($c, CURLOPT_URL, 'http://img.metro.co.uk//i/pix/cartoons/nemi/'.date('Y/m/d').'.gif');
