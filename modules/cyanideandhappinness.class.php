...
/**
 * Class for downloading Cyanide & Happiness comics
...
class cyanideandhappinness {
	public $idref = 'cyanideandhappinness';
	public $title = null;
	...
	public function generate($dir) {
		...
		$c = curl_init();
		curl_setopt($c, CURLOPT_URL, 'http://www.explosm.net/comics/');
		...
		/** Grap comics image */
                if(preg_match('/<img alt="Cyanide and Happiness, a daily webcomic" src="(http:\/\/www.explosm.net\/db\/files\/Comics\/[^\/]+\/[^\.]+\\.png)">/i', $html, $item)) {
			unset($html);
