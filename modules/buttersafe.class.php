...
/**
 * Class for downloading Buttersafe comics
 * http://buttersafe.com/
 *
...
class buttersafe {
	...
	public function generate($dir) {
		...
		$c = curl_init();
		curl_setopt($c, CURLOPT_URL, 'http://buttersafe.com/');
		...
		/** Grap comics image */
                if(preg_match('/\<img src=\"(http:\/\/buttersafe.com\/comics\/[^\.]+.jpg)\" alt=\"([^\"]*)\" title=\"([^\"]*)\" \/\>/i', $html, $item)) {
			unset($html);
